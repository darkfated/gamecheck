...
export default function Profile() {
  ...
  return (
    <div className='container mx-auto px-4 py-8'>
      <div className='bg-[#1a1f2e] shadow rounded-lg p-4 sm:p-6 mb-8'>
          ...
          <div className='flex-1 w-full'>
            <div className='flex flex-col sm:flex-row sm:items-center justify-between gap-4'>
              ...
              <div className='mt-2 sm:mt-0'>
                {isOwnProfile ? (
                  <span className='text-gray-500 text-sm py-1 px-3 rounded-full bg-gray-800/30 border border-gray-700/50'>
                    Это ваш профиль
                  </span>
                ) : (
                  <button
                    ...
                    className={`px-4 py-2 ${
                      profile.isFollowing
                        ...
                        : "bg-[#2563eb]/20 hover:bg-[#2563eb]/30 text-blue-400"
      ...
      <div className='mb-6 border-b border-[#2563eb]/10'>
      ...
      <div className='tab-content'>
        ...
        {/* Вкладка Информация */}
        {activeTab === "info" && (
          <div className='bg-[#1a1f2e] shadow rounded-lg p-6'>
              ...
              <div className='flex flex-col sm:flex-row sm:items-center gap-2'>
                ...
                {isOwnProfile ? (
                  isEditingDiscord ? (
                    <div className='flex flex-col sm:flex-row items-start sm:items-center gap-2 w-full'>
                      <input
                        ...
                        className='px-3 py-1 bg-[#151b27] border border-[#2563eb]/20 rounded-lg text-gray-100 placeholder-gray-500 focus:ring-2 focus:ring-[#2563eb]/30 focus:border-[#2563eb]/30 transition-all text-sm w-full sm:w-48'
                      />
                      <div className='flex gap-2 w-full sm:w-auto'>
                        <button
                          onClick={handleDiscordTagSave}
                          className='flex-1 sm:flex-none px-3 py-1 bg-[#2563eb]/20 text-blue-400 rounded-lg hover:bg-[#2563eb]/30 transition-all duration-200 text-sm font-medium'
                        >
                          Сохранить
                        </button>
                        <button
                  ...
                  <button
                    ...
                    className={`text-blue-400 transition-colors relative ${
                      profile.discordTag
                  ...
                  >
                    ...
                    {profile.discordTag && (
                      <span
                        className={`absolute -top-8 left-1/2 transform -translate-x-1/2 px-2 py-1 bg-black text-white text-xs rounded ${
      ...
      >
        <div className='space-y-4'>
          {followers.length === 0 ? (
            <p className='text-gray-500 text-center'>Нет подписчиков</p>
          ) : (
            followers.map(follower => (
              <div
                key={follower.id}
                className='flex items-center gap-4 p-2 hover:bg-[#1a1f2e]/60 rounded-lg'
              >
                <img
      ...
      >
        <div className='space-y-4'>
          {following.length === 0 ? (
            <p className='text-gray-500 text-center'>Нет подписок</p>
          ) : (
